...
### 七、文献规模与构成（目标 15–20 篇）

一篇优秀论文的参考文献应达到 15–20 篇左右，靠**覆盖完整**而非堆砌达到：

- 方法源头/经典文献：5–8 篇（每个核心方法的奠基文献）
- 同题/赛题评述：3–5 篇（本题的评述与解法论文）
- 相近问题/近期应用：3–5 篇（相邻领域、可迁移方法）
- 数据/题面/求解器：2–3 篇（官方附件、题面来源、HiGHS 等工具）

15–20 是目标而非硬指标：方法单一、找不到足够真实文献时宁缺毋滥，遵循「禁止装饰性引用」。
